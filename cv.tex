...
\definecolor{SwishLineColour}{HTML}{B5A642}
\definecolor{MarkerColour}{HTML}{013220}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Enrico Pezzano}

  \makefield{\faEnvelope[regular]}{\href{mailto:enrico.pezzano@outlook.it}{\texttt{enrico.pezzano@proton.me}}}
  \makefield{\faEnvelope[regular]}{\href{mailto:enrico.pezzano@outlook.it}{\texttt{enriicola@proton.me}}}
  \makefield{\faGithub}{\href{https://github.com/enriicola}{\texttt{@enriicola}}}
  \makefield{\faLinkedin}{\href{https://www.linkedin.com/in/enrico-pezzano/}{\texttt{Enrico Pezzano}}}
  \makefield{\faInstagram}{\href{https://www.instagram.com/enriicola/}{\texttt{@enriicola}}}
  \makefield{\faMobile}{\texttt{+39 3459325625}}

  % You can use a tabular here if you want to line up the fields.
}

% i need to shot a new photo, this one is from 2023, when I still had long hair
% \rightheader{~}
% \begin{fullonly}
% \photo[r]{photo}
% \photoscale{0.13}
...
\makerubric{formazione}
\makerubric{occupazione}
